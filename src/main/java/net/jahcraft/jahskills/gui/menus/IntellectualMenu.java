...
public class IntellectualMenu {
	
	public static Inventory getInv(Player player) {

		Inventory inv = Bukkit.createInventory(null, 54, "Skills - Intellectual");
		setFillers(inv);
	...
	private static void setButtons(Inventory inv, Player p) {
		...
		inv.setItem(22, Intellectual.getSkillButton(p));
		
		int i = 36;
		for (Perk perk : Intellectual.getPerks()) {
