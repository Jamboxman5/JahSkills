...
public class SurvivalistMenu {
	
	public static Inventory getInv(Player player) {

		Inventory inv = Bukkit.createInventory(null, 54, "Skills - Survivalist");
		setFillers(inv);
	...
	private static void setButtons(Inventory inv, Player p) {
		...
		inv.setItem(22, Survivalist.getSkillButton(p));
		
		int i = 36;
		for (Perk perk : Survivalist.getPerks()) {
