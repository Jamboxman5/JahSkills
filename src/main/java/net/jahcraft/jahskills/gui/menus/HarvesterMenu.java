...
public class HarvesterMenu {
	
	public static Inventory getInv(Player player) {

		Inventory inv = Bukkit.createInventory(null, 54, "Skills - Harvester");
		setFillers(inv);
	...
	private static void setButtons(Inventory inv, Player p) {
		...
		inv.setItem(22, Harvester.getSkillButton(p));
		
		int i = 36;
		for (Perk perk : Harvester.getPerks()) {
