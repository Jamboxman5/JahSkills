...
public class HuntsmanMenu {
	
	public static Inventory getInv(Player player) {

		Inventory inv = Bukkit.createInventory(null, 54, "Skills - Huntsman");
		setFillers(inv);
	...
	private static void setButtons(Inventory inv, Player p) {
		...
		inv.setItem(22, Huntsman.getSkillButton(p));
		
		int i = 36;
		for (Perk perk : Huntsman.getPerks()) {
