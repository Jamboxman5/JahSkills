...
public class NaturalistMenu {
	
	public static Inventory getInv(Player player) {

		Inventory inv = Bukkit.createInventory(null, 54, "Skills - Naturalist");
		setFillers(inv);
	...
	private static void setButtons(Inventory inv, Player p) {
		...
		inv.setItem(22, Naturalist.getSkillButton(p));
		
		int i = 36;
		for (Perk perk : Naturalist.getPerks()) {
